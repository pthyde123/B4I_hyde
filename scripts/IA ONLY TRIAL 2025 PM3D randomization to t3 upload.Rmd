---
title: "B4I PM3D 2025 Randomization to T3 Trial"
author: "Peter Hyde"
date: "2024-11-15"
...
randomization <-X2025_PM3D_randomization <- read_excel("data/2025_PM3D_randomization.xlsx") %>% 
  ...
  filter(location == "IA") %>%   ## doing a separate field upload for IA
...
# write.csv(full_trial,str_c("data/",trial_name,"_IA_ONLY_t3_upload.csv"), row.names = FALSE)
